...
namespace TheUsualJoints.App_Start
{
    ...
    public class Utilities
    {
            ...
            <system.net>
              <mailSettings>
                <smtp deliveryMethod="SpecifiedPickupDirectory">
                  <specifiedPickupDirectory pickupDirectoryLocation="C:\Users\ROBERT\Documents\Visual Studio 2013\WebSites\cleantuj\errors"/>
                </smtp>
              </mailSettings>
            </system.net>
            */
            ...
            SmtpClient mailClient = new SmtpClient(TheUsualJointsConfiguration.MailServer);
            // Set credentials (for SMTP servers that require authentication)
            mailClient.Credentials = new NetworkCredential(TheUsualJointsConfiguration.MailUsername, TheUsualJointsConfiguration.MailPassword);
        ...
        public static void LogError(Exception ex)
        {
            ...
            if (TheUsualJointsConfiguration.EnableErrorLogEmail)
            {
                string from = TheUsualJointsConfiguration.MailFrom;
                string to = TheUsualJointsConfiguration.ErrorLogEmail;
                string subject = "The Usual Joints Error Report";
        ...
        {
            // Update every month from http://detectmobilebrowsers.com/ //
        ...
        public static string CleanReplace(string text, string character)
        {
            // remove all characters that aren't a-z, 0-9, dash, underscore or space
            text = purifyUrlRegex.Replace(text, "");
            // remove all leading and trailing spaces
            text = text.Trim();
            // change all dashes, underscores and spaces to dashes
            text = dashesRegex.Replace(text, character);
        ...
        {
            return String.Format("{0:00}-{1:00}-{2:00}", dt.Year, dt.Month, dt.Day);
        }
    }
}