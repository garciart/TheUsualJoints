<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="restaurant-info.aspx.cs" Inherits="TheUsualJoints.Admin.restaurant_info" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="admin_div1">
        ...
        <hr />
            ...
            <asp:HyperLink ID="ScheduleQuickLink" runat="server">Schedule</asp:HyperLink> or
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="changeImage_Button0" runat="server" CommandArgument="0" OnClick="RestaurantImageButton_Click" Text="Change Logo" />
                </td>
            </tr>
            <tr>
                <td>
        ...
        &nbsp;|&nbsp;
        <asp:Label ID="number1" runat="server" /> + <asp:Label ID="number2" runat="server" /> = <asp:TextBox ID="deleteAnswer" runat="server"  Columns="2" MaxLength="3" />&nbsp;
        <asp:Button ID="btnDelete" runat="server" Text="Delete Restaurant" OnClick="btnDelete_Click" BackColor="Red" Font-Bold="True" ForeColor="Yellow" OnClientClick="return confirm('Are you sure you want to delete this restaurant?');" />
        <br class="clear" />
        <br />
        <hr />
